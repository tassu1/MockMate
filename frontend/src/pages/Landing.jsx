...
const TRANSCRIPT_LINES = [
  {
    who: "ai",
    text: "Tell me about the most challenging project you've worked on.",
  },
  {
    who: "you",
    text: "I worked on a school management system with multiple schools...",
  },
  {
    who: "ai",
    text: "What was the biggest technical challenge you faced?",
  },
];
...
function TypedTranscript() {
  ...
  return (
    <div
      ...
      role="log"
      aria-label="Sample AI interview conversation"
    >
      {TRANSCRIPT_LINES.slice(0, shown).map((line, i) => (
        <p
          className={`transcript__line transcript__line--${line.who}`}
          key={i}
        >
      ...
      {shown < TRANSCRIPT_LINES.length && (
        <p
          className={`transcript__line transcript__line--${TRANSCRIPT_LINES[shown].who}`}
        >
          <span className="transcript__tag">
    ...
    <div className="mm">
      ...
      <main id="top">
          ...
          <div className="hero__inner">
            <div className="hero__copy">
              ...
              <p className="hero__sub">
                Upload your resume, choose the role you're
                preparing for, and tell MockMate your
                experience level. Our AI conducts a
                personalized, real-time interview based on
                your background, projects, and the role you
                want.
              </p>
            ...
            <div
              ...
              aria-label="MockMate AI interview preview"
            >
              <div className="call-card">
                <div className="call-card__top">
                  ...
                  <span className="call-card__timer">
                    LIVE
                  </span>
                </div>
              ...
              <div className="floaty-chip floaty-chip--score">
                <span className="floaty-chip__label">
                  Adaptive follow-ups
                </span>

                <span className="floaty-chip__value">
                  AI
                </span>
              </div>
          ...
          <div className="roles-grid">
            {ROLES.map((r) => (
              <article
                ...
                key={r.id}
              >
                <span className="role-card__track">
                  {r.track}
                </span>
        ...
        >
          <div className="inputs-row">
            <div className="input-card">
              ...
              <p>
                Upload your resume so the AI can understand
            ...
            <div className="input-card">
              ...
              <p>
                Choose the role you're interviewing for so
                questions stay relevant to your target
                position.
              </p>
            </div>
            ...
            <div className="input-card">
              ...
              <p>
                Select Intern, Junior, Mid-level, or Senior
                to control the expected depth of the
                interview.
              </p>
            </div>
          </div>
          ...
          <div className="report-panel">
            <div className="report-panel__scores">
              ...
              <div className="note-block note-block--rec">
                <h4>YOU</h4>
                <p>
                  I worked on a school management system
                  where I had to handle data for multiple
                  schools.
                </p>
              </div>
              ...
              <div className="note-block note-block--rec">
                <h4>YOU</h4>
                <p>
                  Making sure one school's data couldn't
                  accidentally be accessed by another.
                </p>
              </div>
            </div>
            ...
            <div className="report-panel__notes">
              <div className="note-block note-block--strength">
                <h4>Adaptive</h4>
                <p>
                  Follow-up questions are generated from
              ...
              <div className="note-block note-block--weakness">
                <h4>Personalized</h4>
                <p>
                  Questions are grounded in your resume,
                  projects, role, and experience level.
                </p>
              </div>
              ...
              <div className="note-block note-block--rec">
                <h4>Real-time</h4>
                <p>
                  The interview keeps moving as a natural
          ...
          <div className="report-panel">
              ...
              {REPORT_METRICS.map((m) => (
                ...
                >
                  ...
                  <span className="score-row__value">
                    {m.v}
                    <span className="score-row__unit">
                      {m.u}
                    </span>
                  </span>
                </div>
            ...
            <div className="report-panel__notes">
              <div className="note-block note-block--strength">
                ...
                <p>
                  Clear structuring of answers; strong
              ...
              <div className="note-block note-block--weakness">
                ...
                <p>
                  Under-explains trade-offs until prompted
                  by a follow-up.
                </p>
              </div>
              ...
              <div className="note-block note-block--rec">
                ...
                <p>
                  ...
                  trade-offs, and reasoning more clearly.
                </p>
              </div>
              ...
              <div className="note-block note-block--rec">
                ...
                <p>
                  Lead with the problem, explain your
                  decision, and clearly communicate the
                  trade-offs.
                </p>
              </div>
            </div>
        ...
        <section className="final-cta">
          <div className="final-cta__inner">
            <h2>
              Your next interview shouldn't be the first
              time you practice.
            </h2>
      ...
      <footer className="footer">
        <div className="footer__inner">
          ...
          <p>
            &copy; {new Date().getFullYear()} MockMate.
